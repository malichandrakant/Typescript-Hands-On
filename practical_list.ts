...
let str2:string='Welcome to string operations.';
let str3:string=`This is a template ${str} string in TypeScript.`;
...
// Trimming
let strWithSpaces:string="   TypeScript String Operations   ";
...
//Conatination
let greet:string=str.concat(" ",str2);
